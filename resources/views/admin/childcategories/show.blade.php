						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">View ChildCategory</h5>
								</div>
								<hr>
								<form class="row g-3"action="{{ route('admin.childcategories.update', $child_category->id) }}"  method="POST" enctype="multipart/form-data" id="post-add-form">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="inputFirstName" placeholder="childcategory Name" name="name" value="{{ $child_category->name}}" disabled>
                                        @error('name')
									...
									<div class="col-md-6">
										...
										<input type="file" id="img-upload1" class="form-control" name="image" value="{{ $child_category->image}}" disabled>
									</div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="category-name" class="form-select" name="sub_category_id" disabled>
