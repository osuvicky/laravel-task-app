						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Add Childcategory</h5>
								</div>
								<hr>
								<form class="row g-3" action="{{ route('admin.childcategories.store') }}"  method="POST" enctype="multipart/form-data" id="post-add-form">
                                    @csrf
									<div class="col-md-6">
										<label for="inputFirstName" class="form-label">Name</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="Childcategory Name" name="name" value="{{old('name')}}">
                                        @error('name')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select"  id="category-name" class='select2' name="sub_category_id">
