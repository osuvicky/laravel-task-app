					...
					<div class="col-12 col-xl-12">
						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								...
								<hr>
								<form class="row g-3" action="{{ route('admin.subcategories.store') }}"  method="POST" enctype="multipart/form-data" id="post-add-form">
                                    @csrf
									<div class="col-md-6">
										<label for="inputFirstName" class="form-label">Name</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="Subcategory Name" name="name" value="{{old('name')}}">
                                        @error('name')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select"  id="category-name" class='select2' name="category_id">
