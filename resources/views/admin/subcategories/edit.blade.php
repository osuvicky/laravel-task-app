							...
							<div class="card-body p-5">
								...
								<form class="row g-3"action="{{ route('admin.subcategories.update', $sub_category->id) }}"  method="POST" enctype="multipart/form-data" id="post-add-form">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="inputFirstName" placeholder="Subcategory Name" name="name" value="{{ $sub_category->name}}">
                                        @error('name')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="category-name" class="form-select" name="category_id">
