                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-12 mb--sm">
                        <div class="gradient-wrapper">
                            ...
                            <div class="input-layout1 gradient-padding post-ad-page">
                                <form action="{{ route('admin.states.store') }}"  method="POST" id="post-add-form">
                                    @csrf
                                    <div class="border-bottom-2 mb-50 pb-30">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="category-name" class='select2' name="country_id">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" placeholder="State Name" name="name" value="{{old('name')}}">
                                                </div>
                                            </div>
                                        </div>
                                        @error('name')
